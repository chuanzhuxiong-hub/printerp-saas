  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <section className="grid gap-3 sm:gap-4 md:grid-cols-3">
        <Link href="/app/purchases/new" className="rounded-2xl border border-blue-200 bg-blue-50 p-4 shadow-sm transition hover:bg-blue-100/60 sm:p-5">
        ...
        <Link href="/app/purchases/packaging/new" className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-blue-200 hover:bg-blue-50/40 sm:p-5">
        ...
        <Link href="/app/reports/purchases" className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:border-blue-200 hover:bg-blue-50/40 sm:p-5">
