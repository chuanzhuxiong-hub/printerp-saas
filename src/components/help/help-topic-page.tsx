  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      >
        ...
        {!topic.route.startsWith("/app/help") && <Link href={topic.route} className="inline-flex min-h-10 w-full items-center justify-center rounded-lg bg-brand px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-700 sm:w-auto">打开功能</Link>}
      </PageHeader>
      ...
      <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6 md:p-8">
          ...
          {topic.sections.map((section) => (
            <section key={section.title}>
              ...
              {section.tips && section.tips.length > 0 && (
                <div className="mt-4 rounded-xl border border-emerald-200 bg-emerald-50 p-3 sm:p-4">
